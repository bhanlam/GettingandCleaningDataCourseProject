...
Although there are no major changes to the variable names, the Table 1 below will summarise the abbreviations used in the variable names in the final output file *"avgbyparticipant.csv"*. An indication of *NA* signifies no changes to the orginal abbreviations.
